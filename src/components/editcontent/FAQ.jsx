...
const FAQpage = () => {
  const [faqList, setFaqList] = useState([
    ...
    { id: 4, question: "How to delete a user?", answer: "Go to the Users tab and click the delete button for the user." },
    { id: 5, question: "How to reset a password?", answer: "Click 'Forgot Password' on the login page." },
  ]);
  ...
  return (
    <div className="p-6 bg-[#242424] min-h-screen">
      <h1 className="text-2xl font-bold mb-6 text-[#FFFFFFB2]">FAQ Management</h1>
